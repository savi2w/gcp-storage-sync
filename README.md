...
| `SOURCE_DIR` | The local directory (or file) you wish to sync/upload to GCP Storage. For example, `public`. Defaults to your entire repository. | `ENV` | **Yes** | N/A |
...
##### Thanks to [s3-sync-action](https://github.com/jakejarvis/s3-sync-action).
